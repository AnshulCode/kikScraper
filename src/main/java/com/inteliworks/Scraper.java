...
public class Scraper {
    ...
    public Scraper() throws JSONException {
        Document doc = null;
        try {
    ...
    private JSONObject parse(String line) throws JSONException {
    ...
    public  JSONObject getContact(String name) {
    ...
    public  JSONArray getJSONArrayStaff() {
        return ja;
    }
}
